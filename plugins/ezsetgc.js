...
cmd({
  ...
  try {
    ...
    setTimeout(() => {
      ...
      _0x515443("> *NOW GROUP IS OPENED BY ✧MUSTAFFA MK✧ BOT*");
    }, _0x57d309);
...
cmd({
  ...
  try {
    ...
    setTimeout(() => {
      ...
      _0x5c514e("> *NOW GROUP CLOSED BY ✧MUSTAFFA MK✧*");
    }, _0x4b2fe4);
...
cmd({
  ...
  try {
    ...
    const _0x23264b = await _0x188ee4.sendMessage(_0x5a0744.chat, {
      'text': "*GROUP CHAT MUTED BY ✧MUSTAFFA MK✧* 🔒"
    }, {
      'quoted': _0x2926d7
    });
...
cmd({
  ...
  try {
    ...
    const _0x74b371 = await _0x298fe1.sendMessage(_0x2602ac.chat, {
      'text': "*GROUP CHAT UNMUTED BY ✧MUSTAFFA MK✧* 🔒"
    }, {
      'quoted': _0x116d41
    });
