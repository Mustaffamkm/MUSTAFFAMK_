...
cmd({
  ...
  reply("✧MUSTAFFA MK✧ Fetching audio... 🎧");
  ...
  if (!spotifySent && !youtubeSent) {
    ...
    reply("✧MUSTAFFA MK✧: Spotify audio sent successfully.");
  } else if (youtubeSent) {
    reply("✧MUSTAFFA MK✧: YouTube audio sent successfully.");
  }
});
